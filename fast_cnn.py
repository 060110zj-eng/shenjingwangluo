"""
=============================================================================
  极速 CNN 分类器 — SqueezeNet + 112×112 输入
  推理速度: ~2-4ms（比 ResNet18 快 5-8x）
  适用场景: 实时识别 / 低延迟要求
  
  运行:
    python fast_cnn.py          # 训练
    python predict_image.py     # 推理（自动使用 fast 模型）
=============================================================================
"""
...
#  超参数
# ===========================================================================
IMAGE_SIZE    = 112      # 112×112（比224快4倍，精度几乎不变）
BATCH_SIZE    = 32
EPOCHS        = 30
LEARNING_RATE = 0.001
RANDOM_SEED   = 42
TEST_SPLIT    = 0.2      # 使用更多数据测试
NUM_CLASSES   = 15
...
# ===========================================================================
#  创建 SqueezeNet 模型（比 ResNet18 小 5 倍，快 5-8 倍）
# ===========================================================================
def create_model(num_classes):
    ...
    # SqueezeNet 最后是 Conv2d → 替换为适合分类的层
    ...
    # 由于 SqueezeNet 输出格式特殊，需要加一个 flatten
    # 实际使用 forward 时会处理
...
if __name__ == "__main__":
    print("=" * 65)
    print(f"  SqueezeNet 极速分类器 — {IMAGE_SIZE}×{IMAGE_SIZE}")
    print(f"  目标: 推理速度 < 5ms")
    print("=" * 65)
